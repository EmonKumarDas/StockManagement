...
class ShowLostData extends StatefulWidget {
  const ShowLostData(
      {super.key,
      required this.item,
  ...
  final List date;
  @override
  State<ShowLostData> createState() => _ShowLostDataState();
}
...
class _ShowLostDataState extends State<ShowLostData> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          appBar: AppBar(
            title: const Text('Lost Data Show BY Date'),
          ),
          body: Center(
